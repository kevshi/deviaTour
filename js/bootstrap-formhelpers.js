...
var BFHCountriesInternationalPayrollList = {
  'AX': 'Åland Islands',
  'AL': 'Albania',
  'AS': 'American Samoa',
  'AD': 'Andorra',
...
var BFHStatesList = {
  ...
  'VG':{
    '1' : {'code':'VGAN','name':'Anegada'},
    '2' : {'code':'VGTO','name':'Tortola'},
    '3' : {'code':'VGJVD','name':'Jost Van Dyke'},
    '4' : {'code':'VGPI','name':'Peter Island'},
    '5' : {'code':'VGVG','name':'Virgin Gorda'}
  },
  'IO':{
  ...
  'PH':{
    ...
    '52' : {'code':'NOC','name':'Negros Occidental'},
    '53' : {'code':'NOR','name':'Negros Oriental'},
    '54' : {'code':'NCT','name':'North Cotabato'},
    '55' : {'code':'NSM','name':'Northern Samar'},
    '56' : {'code':'NEC','name':'Nueva Ecija'},
    '57' : {'code':'NVZ','name':'Nueva Vizcaya'},
    '58' : {'code':'PLW','name':'Palawan'},
    '59' : {'code':'PMP','name':'Pampanga'},
    '60' : {'code':'PNG','name':'Pangasinan'},
    '61' : {'code':'QZN','name':'Quezon'},
    '62' : {'code':'QRN','name':'Quirino'},
    '63' : {'code':'RIZ','name':'Rizal'},
    '64' : {'code':'ROM','name':'Romblon'},
    '65' : {'code':'SMR','name':'Samar'},
    '66' : {'code':'SRG','name':'Sarangani'},
    '67' : {'code':'SQJ','name':'Siquijor'},
    '68' : {'code':'SRS','name':'Sorsogon'},
    '69' : {'code':'SCO','name':'South Cotabato'},
    '70' : {'code':'SLE','name':'Southern Leyte'},
    '71' : {'code':'SKU','name':'Sultan Kudarat'},
    '72' : {'code':'SLU','name':'Sulu'},
    '73' : {'code':'SNO','name':'Surigao del Norte'},
    '74' : {'code':'SSU','name':'Surigao del Sur'},
    '75' : {'code':'TAR','name':'Tarlac'},
    '76' : {'code':'TAW','name':'Tawi-Tawi'},
    '77' : {'code':'ZBL','name':'Zambales'},
    '78' : {'code':'ZNO','name':'Zamboanga del Norte'},
    '79' : {'code':'ZSU','name':'Zamboanga del Sur'},
    '80' : {'code':'ZSI','name':'Zamboanga Sibugay'}
  },
  'PN':{
  ...
  'RS':{
    '1' : {'code':'RSB1','name':'Belgrade'},
    '2' : {'code':'RSB2','name':'Bor'},
    '3' : {'code':'RSB3','name':'Branicevo'},
    '4' : {'code':'RSB4','name':'Central Banat'},
    '5' : {'code':'RSB5','name':'Danube'},
    '6' : {'code':'RSB6','name':'Jablanica'},
    '7' : {'code':'RSB7','name':'Kolubara'},
    '8' : {'code':'RSB8','name':'Macva'},
    '9' : {'code':'RSB9','name':'Morava'},
    '10' : {'code':'RSB10','name':'Nisava'},
    '11' : {'code':'RSB11','name':'North Backa'},
    '12' : {'code':'RSB12','name':'North Banat'},
    '13' : {'code':'RSB13','name':'Pcinja'},
    '14' : {'code':'RSB14','name':'Pirot'},
    '15' : {'code':'RSB15','name':'Pomoravlje'},
    '16' : {'code':'RSB16','name':'Rasina'},
    '17' : {'code':'RSB17','name':'Raska'},
    '18' : {'code':'RSB18','name':'South Backa'},
    '19' : {'code':'RSB19','name':'South Banat'},
    '20' : {'code':'RSB20','name':'Srem'},
    '21' : {'code':'RSB21','name':'Sumadija'},
    '22' : {'code':'RSB22','name':'Toplica'},
    '23' : {'code':'RSB23','name':'West Backa'},
    '24' : {'code':'RSB24','name':'Zajecar'},
    '25' : {'code':'RSB25','name':'Zlatibor'}
  },
  'RU':{
...
+function ($) {
  ...
  var BFHCountriesIntl = function (element, options) {
    this.options = $.extend({}, $.fn.bfhcountriesintl.defaults, options);
    this.$element = $(element);
  ...
  BFHCountries.prototype = {
    ...
    BFHCountriesIntl.prototype = {

    constructor: BFHCountriesIntl,
    ...
    getCountries: function() {
      ...
      if (this.options.available) {
        if (typeof this.options.available === 'string') {
          ...
          for (country in BFHCountriesInternationalPayrollList) {
            if (BFHCountriesInternationalPayrollList.hasOwnProperty(country)) {
              if ($.inArray(country, this.options.available) >= 0) {
                countries[country] = BFHCountriesInternationalPayrollList[country];
              }
            }
          }
        } else {
        ...
        return BFHCountriesInternationalPayrollList;
      }
    },
    ...
    displayCountry: function () {
      ...
      if (this.options.flags === true) {
        this.$element.html('<i class="glyphicon bfh-flag-' + value + '"></i> ' + BFHCountriesInternationalPayrollList[value]);
      } else {
        this.$element.html(BFHCountriesInternationalPayrollList[value]);
      }
    }
  ...
  $.fn.bfhcountries.defaults = {
   ...
   var oldintl = $.fn.bfhcountriesintl;

  $.fn.bfhcountriesintl = function (option) {
    return this.each(function () {
      var $this,
          data,
          options;
      ...
      $this = $(this);
      data = $this.data('bfhcountriesintl');
      options = typeof option === 'object' && option;

      if (!data) {
        $this.data('bfhcountriesintl', (data = new BFHCountriesIntl(this, options)));
      }
      if (typeof option === 'string') {
        data[option].call($this);
      }
  ...
  $.fn.bfhcountriesintl.Constructor = BFHCountriesIntl;

  $.fn.bfhcountriesintl.defaults = {
    country: '',
    available: '',
    flags: false,
    blank: true,
  ...
  $.fn.bfhcountriesintl.noConflict = function () {
    $.fn.bfhcountriesintl = oldintl;
    return this;
  };
...
$('form select.bfh-countriesintl, span.bfh-countriesintl, div.bfh-countriesintl').each(function () {
      var $countries;
      ...
      $countries.bfhcountriesintl($countries.data());
    });
  });
...
+function ($) {
  ...
  BFHCurrencies.prototype = {
    ...
    getCurrencies: function () {
      ...
      if (this.options.available) {
        currencies = [];
        var countryintl = $('#countries_intl1 input').val();
        console.log(countryintl);
        if (countryintl == 'PH') {
            this.options.available = 'PHP,USD,GBP,EUR';
        } else {
            this.options.available = 'USD,GBP,EUR';
        }
        this.options.available = this.options.available.split(',');
    ...
    var BFHCurrenciesIntl = function (element, options) {
    this.options = $.extend({}, $.fn.bfhcurrenciesintl.defaults, options);
    this.$element = $(element);
  ...
  BFHCurrenciesIntl.prototype = {

    constructor: BFHCurrenciesIntl,
  ...
  $.fn.bfhcurrencies.defaults = {
    ...
    var old2 = $.fn.bfhcurrenciesintl;

  $.fn.bfhcurrenciesintl = function (option) {
    return this.each(function () {
      var $this,
          data,
          options;
      ...
      $this = $(this);
      data = $this.data('bfhcurrenciesintl');
      options = typeof option === 'object' && option;

      //if (!data) {
        $this.data('bfhcurrenciesintl', (data = new BFHCurrenciesIntl(this, options)));
      //}
      if (typeof option === 'string') {
        data[option].call($this);
      }
  ...
  $.fn.bfhcurrenciesintl.Constructor = BFHCurrenciesIntl;

  $.fn.bfhcurrenciesintl.defaults = {
    currency: '',
    available: '',
    flags: false,
    blank: true
  ...
  $.fn.bfhcurrencies.noConflict = function () {
    ...
    $.fn.bfhcurrenciesintl.noConflict = function () {
    $.fn.bfhcurrenciesintl = old2;
    return this;
  };
  ...
  $(document).ready( function () {
    ...
    $(document).ready( function () {
        $('form select.bfh-currenciesintl, span.bfh-currenciesintl, div.bfh-currenciesintl').each(function () {
                var $currencies;
                ...
                $currencies.bfhcurrenciesintl($currencies.data());
            });
        $('form select.bfh-countriesintl, span.bfh-countriesintl, div.bfh-countriesintl input').change(function () {
            $('form select.bfh-currenciesintl, span.bfh-currenciesintl, div.bfh-currenciesintl').each(function () {
                var $currencies;
  ...
  BFHDatePicker.prototype = {
    ...
    setDate: function() {
      ...
      if (date === '' || date === 'today' || date === undefined) {
        ...
        if (date === 'today') {
          this.$element.val(formatDate(format, today.getMonth(), Number(today.getFullYear()) - 13, today.getDate()));
        }

        this.$element.data('month', today.getMonth());
        this.$element.data('year', Number(today.getFullYear())-13);
      } else {
  ...
  BFHPhone.prototype = {
    ...
    addFormatter: function() {
      ...
      if (this.options.country !== '') {
        $country = $(document).find('#' + this.options.country + " input");
...
+function ($) {
  ...
  BFHStates.prototype = {
    ...
    loadStates: function (country) {
      ...
      if (this.options.blank === true) {
        this.$element.append('<option value="" selected disabled >State</option>');
      }
      if (this.options.showblank === true) {
        this.$element.append('<option value=""  ></option>');
      }
